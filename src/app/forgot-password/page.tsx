                    ...
                    <div className="bg-card/80 backdrop-blur-2xl border border-border rounded-3xl p-8 md:p-10 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)]">
                        ...
                        {success ? (
                            ...
                            >
                                ...
                                <h2 className="text-2xl font-bold text-foreground tracking-tight mb-2 font-syne">Check your inbox</h2>
                                ...
                                <Link
                                    href="/login"
                                    className="flex items-center gap-2 w-full justify-center py-4 bg-primary text-white font-bold text-xs rounded-xl shadow-xl hover:shadow-[0_20px_40px_-10px_rgba(40,114,161,0.2)] hover:-translate-y-1 transition-all duration-300 uppercase tracking-widest"
                                >
                            ...
                            <>
                                {/* Header */}
                                <div className="mb-8">
                                    <h1 className="text-3xl font-bold text-foreground tracking-tight mb-1.5 font-syne">Reset password</h1>
