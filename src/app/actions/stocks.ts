...
export async function executeStockTrade(params: TradeParams) {
    ...
    try {
        ...
        // SECURITY FIX: Never trust client-provided financial data (price, changePercent).
        // Always fetch authoritative live market data server-side to prevent parameter tampering.
