...
// ⚡ BOLT OPTIMIZATION: Extracted CustomTooltip outside to prevent Recharts from unmounting
// and remounting the tooltip component on every hover event, eliminating render jank.
