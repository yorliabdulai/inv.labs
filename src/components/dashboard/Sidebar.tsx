    ...
    const NavItem = ({ href, label, icon: Icon, onClick, id }: { href: string; label: string; icon: React.ElementType; onClick?: () => void; id?: string }) => {
        ...
        return (
            <Link
                ...
                onClick={onClick}
                id={id}
                className={`group flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all duration-150 min-h-[40px] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ${active
        ...
        <>
            ...
            <aside className="hidden md:flex flex-col w-64 h-screen fixed left-0 top-0 bg-background border-r border-border z-50 transition-colors duration-300">
                ...
                <div className="p-3 border-t border-border">
                    <Link href="/dashboard/profile" className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-muted/50 transition-colors mb-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 w-full px-3 py-2.5 text-sm font-semibold text-muted-foreground hover:text-red-500 hover:bg-red-500/5 rounded-xl transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                    >
                        <LogOut size={16} />
                        Sign out
                    </button>
