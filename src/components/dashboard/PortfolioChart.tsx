...
// ⚡ BOLT OPTIMIZATION: Extracted CustomTooltip outside of the PortfolioChart render function.
// Previously, defining this component inside the render body caused React to create a
// brand new component reference on every single render pass. This forced the tooltip to
// completely unmount and remount constantly (especially during rapid hover events),
// leading to severe main-thread blocking and performance jank. By extracting it and
// passing dependencies as props, we eliminate these unnecessary lifecycle re-evaluations.
