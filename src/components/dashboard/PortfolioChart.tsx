...
const CustomTooltip = ({ active, payload, label, chartType, startingValue }: any) => {
            ...
            case 'candle':
                return (
                    <ComposedChart data={chartData} margin={{ top: 20, right: 30, left: 10, bottom: 0 }}>
                        ...
                        <Tooltip content={<CustomTooltip chartType={chartType} startingValue={startingValue} />} cursor={{ stroke: tickColor, strokeWidth: 1, strokeOpacity: 0.2 }} />
            ...
            case 'bar':
                return (
                    <BarChart data={chartData} margin={{ top: 20, right: 30, left: 10, bottom: 0 }}>
                        ...
                        />
                        <YAxis hide domain={['auto', 'auto']} />
                        <Tooltip content={<CustomTooltip chartType={chartType} startingValue={startingValue} />} cursor={{ fill: 'var(--muted)', opacity: 0.3, radius: 8 }} />
                        <Bar
                            dataKey="value"
                            fill="url(#barGrad)"
                            radius={[6, 6, 0, 0]}
            ...
            default:
                return (
                    <AreaChart data={chartData} margin={{ top: 20, right: 30, left: 10, bottom: 0 }}>
                        ...
                        />
                        <YAxis hide domain={['auto', 'auto']} />
                        <Tooltip content={<CustomTooltip chartType={chartType} startingValue={startingValue} />} />
                        <Area
                            type="monotone"
                            dataKey="value"
                            stroke="var(--primary)"
