...
// ⚡ BOLT OPTIMIZATION: Extracted CustomTooltip outside of PortfolioChart render function
// to prevent React from recreating the component reference on every render, which causes
// unmounting/remounting and severe performance jank on hover events.
