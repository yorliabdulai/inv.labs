        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-xl animate-in fade-in duration-300 font-instrument-sans">
            <div className="relative w-full max-w-lg bg-card border border-border shadow-premium rounded-3xl overflow-hidden animate-in zoom-in-95 duration-500">
                ...
                <div className="flex items-center justify-between p-8 border-b border-border bg-card/80 backdrop-blur-md">
                    ...
                    <button onClick={onClose} className="w-10 h-10 flex items-center justify-center text-muted-foreground hover:text-foreground bg-muted hover:bg-muted/80 border border-border rounded-xl transition-all" aria-label="Close">
                        <X size={20} />
                    </button>
                </div>
