    ...
    return (
        <div className="space-y-4">
            {transactions.map((tx) => (
                <div
                    key={tx.id}
                    className="group flex items-center justify-between p-5 rounded-[2px] bg-white/5 hover:bg-white/10 transition-all cursor-pointer border border-white/5 hover:border-[#C05E42]/20"
                >
                    <div className="flex items-center gap-5">
                        <div className={`w-12 h-12 rounded-[2px] flex items-center justify-center flex-shrink-0 transition-all group-hover:scale-105 ${tx.type.includes('BUY')
            ...
            <button className="w-full mt-6 py-5 text-[10px] font-black text-[#F9F9F9] uppercase tracking-[0.4em] bg-white/5 hover:bg-[#C05E42] border border-white/5 rounded-[2px] transition-all flex items-center justify-center gap-3 group shadow-xl hover:shadow-[#C05E42]/20">
