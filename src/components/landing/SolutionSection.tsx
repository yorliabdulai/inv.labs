      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-20 max-w-7xl">
        <div className="mb-20 max-w-4xl text-left">
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 text-primary w-fit text-sm font-semibold mb-6"
          >
          ...
          <motion.h2
            ...
            className="text-[2.5rem] sm:text-[4rem] md:text-[5rem] lg:text-[6rem] font-bold text-foreground leading-[0.9] tracking-[-0.04em] text-balance mb-8 break-words"
          >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-16 items-center">
          ...
          >
            <div className="absolute inset-0 bg-primary/10 rounded-[2.5rem] blur-2xl transition-all duration-500 group-hover:bg-primary/20" />

            <div className="relative bg-card shadow-[0_8px_40px_-12px_rgba(0,0,0,0.12)] border border-border rounded-[2.5rem] p-8 overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] hover:ring-border/50">
              ...
              <div className="flex justify-between items-center mb-10">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-secondary flex items-center justify-center font-bold text-foreground">MTN</div>
                  <div>
                    <h4 className="font-bold text-foreground leading-none">Scancom PLC</h4>
                    <span className="text-xs text-muted-foreground font-medium tracking-wide">MTNGH</span>
                  </div>
                </div>
                <div className="text-right">
                  <p className="font-bold text-foreground text-xl tracking-tighter leading-none">GH₵ 1.82</p>
                  <span className="text-[10px] uppercase tracking-widest text-emerald-500 font-bold mt-1 block">Gain: 2.3%</span>
                </div>
              </div>

              <div className="space-y-4 mb-8">
                <div className="bg-secondary/50 rounded-xl p-4 border border-border flex justify-between items-center">
                  <span className="text-sm font-semibold text-muted-foreground">Virtual Capital</span>
                  <span className="font-bold text-foreground">GH₵ 10,000.00</span>
                </div>
                <div className="bg-secondary/50 rounded-xl p-4 border border-border flex justify-between items-center">
                  <span className="text-sm font-semibold text-muted-foreground">Practice Quantity</span>
          ...
          >
                ...
                {[
                  ...
                  <div key={i} className="flex gap-5 items-start">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground leading-relaxed font-medium tracking-tight text-base">{item.text}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <button className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 text-sm font-bold text-white bg-zinc-900 dark:bg-primary rounded-full transition-all shadow-xl hover:-translate-y-1 hover:shadow-primary/20 w-full sm:w-fit antialiased border border-transparent dark:border-primary/20">
