                    ...
                    <div ref={cardRef} className="w-[320px] bg-card border border-border rounded-2xl shadow-2xl p-6 overflow-hidden relative group">
                        ...
                        <div className="flex items-start justify-between mb-4">
                            ...
                            <button 
                                ...
                                className="text-muted-foreground hover:text-foreground transition-colors p-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                            >
                                <X size={16} />
                            </button>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-auto">
                            ...
                            <div className="flex gap-2">
                                ...
                                <button
                                    onClick={handleNext}
                                    aria-label={currentStepIndex === STEPS.length - 1 ? "Complete tour" : "Next step"}
