        ...
        <div className="fixed inset-y-0 right-0 w-96 bg-white border-l border-gray-200 shadow-2xl z-50 flex flex-col">
            ...
            <div className="flex items-center justify-between p-6 border-b border-gray-100">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-[#1A1C4E] flex items-center justify-center">
            ...
            <div className="border-b border-gray-100">
                <div className="flex gap-1 p-4 overflow-x-auto">
                    <div className="px-4 py-2 rounded-lg font-bold text-sm bg-indigo-600 text-white shadow-lg shadow-indigo-100">
                        My Watchlist
