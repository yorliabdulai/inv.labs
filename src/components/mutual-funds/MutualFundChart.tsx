...
// ⚡ BOLT OPTIMIZATION: Moved CustomTooltip outside of the MutualFundChart component.
// Declaring a component inside another component's render function causes React to create
// a completely new component reference on every single render. For Recharts, this means the
// Tooltip component was being completely unmounted and remounted on every mouse hover tick,
// causing extreme main-thread jank and performance degradation.
