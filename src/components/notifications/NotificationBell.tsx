...
function NotificationItem({
    ...
    return (
        <motion.div
            ...
            role="button"
            tabIndex={0}
            aria-label={notification.is_read ? `Read notification: ${notification.title}` : `Unread notification: ${notification.title}`}
        >
            {/* Unread dot */}
            {!notification.is_read && (
            ...
            <button
                ...
                className="absolute right-2 bottom-2 p-1.5 rounded-lg opacity-0 group-hover:opacity-100 focus-visible:opacity-100 transition-opacity bg-red-500/10 text-red-500 hover:bg-red-500/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400 focus-visible:ring-offset-1"
