    ...
    return (
        ...
        >
            ...
            <button
                ...
                className="absolute right-2 bottom-2 p-1.5 rounded-lg opacity-0 group-hover:opacity-100 focus-visible:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-500/50 transition-opacity bg-red-500/10 text-red-500 hover:bg-red-500/20"
