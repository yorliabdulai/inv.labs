            ...
            <AnimatePresence>
                {open && (
                    <motion.div
                        ...
                        className="absolute top-[calc(100%+10px)] right-0 w-[340px] max-h-[520px] flex flex-col bg-card border border-border rounded-2xl shadow-[0_24px_48px_-8px_rgba(0,0,0,0.25)] z-50 overflow-hidden"
