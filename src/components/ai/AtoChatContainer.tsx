...
import { AtoAgentMode } from "./AtoAgentMode";
import { AtoModeSwitcher } from "./AtoModeSwitcher";
 ...
 */
 export function AtoChatContainer() {
     ...
     const agentEnabled = isAtoAgentModeEnabled();
    ...
    const handleMinimize = () => {
     ...
     return (
         <>
             ...
             {isChatOpen && !isMinimized && agentEnabled && (
                 <AtoModeSwitcher mode={mode} onChange={setMode} isAgentEnabled={agentEnabled} />
             )}

             {/* Full panel: Chat or Agent Mode */}
             {mode === "agent" && agentEnabled ? (
                 <AtoAgentMode
