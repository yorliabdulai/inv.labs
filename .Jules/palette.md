...
## 2026-06-12 - BottomNav Focus States
**Learning:** The mobile BottomNav component's interactive `Link` elements lacked visible focus indicators for keyboard navigation.
**Action:** Applied `focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 rounded-xl` directly to the Link components to ensure accessibility on mobile views.
